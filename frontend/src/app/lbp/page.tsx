                ...
                <HoloPanel size="md" depth="foreground" glow="cyan">
                    <div style={{ padding: '48px 32px', textAlign: 'center' }}>
                        ...
                        <p style={{
                            ...
                            Fund governance participation details will be announced prior to launch.
                            Full details on voting, proposals, and participation will be shared across all channels.
                        </p>
                        <Link href="/" style={{
