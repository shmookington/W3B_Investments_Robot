/**
 * Portfolio Monthly Returns API
 *
 * GET /api/portfolio/by-month
 * Proxies to MONOLITH engine: GET /portfolio/monthly-returns
 */
...
export async function GET() {
    try {
        ...
        const res = await fetch(`${ENGINE_URL}/portfolio/monthly-returns`, {
